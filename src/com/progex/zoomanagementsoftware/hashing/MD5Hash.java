...
/**
 * This class provides simple functions to hash a String and to verify the hash
 * of a String using MD5 algorithm.
 */
public class MD5Hash {
    ...
    /**
     * Method which is used to verify that a password belongs to a given md5
