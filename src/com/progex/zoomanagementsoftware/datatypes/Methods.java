...
public class Methods {
    ...
    /**
     * Method which has been implemented to convert a salutation String to an
     * enum type.
     *
     * @param salutationStr
     * @return The corresponding salutation,diverse, mr or mrs.
     */
    ...
    /**
     * Method which has been implemented to convert a Salutation enum to a
     * String.
     *
     * @param salutation
     * @return The corresponding salutation if mapping is possible, else an
     * empty String
     */
    ...
    /**
     * Method which has been implemented to convert a shift String to an enum
     * type
     *
     * @param shiftStr
    ...
    /**
     * Method which has been implemented to convert a Shift enum to a String.
     *
     * @param shift
     * @return The corresponding shift as String if mapping is possible, else an
     * empty String
     */
    ...
    public boolean isValidDateString(String dateString) {
        ...
        try {
            ...
            System.err.println("Parse Exception in isValidDateString()");
    ...
    /**
     * Method to remove the seconds from da String with the format: YYYY-MM-DD
     * HH:MI:SS.
     *
     * @param dateString
    ...
    /**
     * Method to check if a feeding time String representation corresponds to
     * the value format of the database.
     *
     * @param feedingTime
    ...
    public boolean isValidFeedingTime(String feedingTime) {
        ...
        if (feedingTime.length() > pattern.length()) {
            return false;
        }
        try {
            ...
            System.err.println("Parse Exception in isValidFeedingTime()");
            System.out.println(e.getMessage());
            return false;
        }
    }
    ...
    /**
     * Method to check if an email has a valid pattern. Regular expression from:
    ...
    /**
     * Method gets a Time format in "YYYY-MM-DD HH:MM:SS.MS" and cuts it to
     * "HH:MM"
     *
     * @param time
