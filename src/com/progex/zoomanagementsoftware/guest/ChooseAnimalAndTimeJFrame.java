...
public class ChooseAnimalAndTimeJFrame extends javax.swing.JFrame {
    ...
    private void setComboxAnimals() {
        ...
        String[] animalNames = new String[animals.size() + 1];
        animalNames[0] = "Tier auswählen";

        for (int i = 0; i < animals.size(); i++) {

            animalNames[i + 1] = animals.get(i);

        }
        DefaultComboBoxModel defaultTableModel = new DefaultComboBoxModel(animalNames);
    ...
    private void setComboxTime() {
        ...
        String[] feedingTimes = new String[times.size() + 1];
        feedingTimes[0] = "Zeit auswählen";

        for (int i = 0; i < times.size(); i++) {

            feedingTimes[i + 1] = times.get(i);
        }
        DefaultComboBoxModel defaultTableModel = new DefaultComboBoxModel(feedingTimes);
    ...
    private void initComponents() {
        ...
        jComboTime.setFont(new java.awt.Font("Calibri", 0, 24)); // NOI18N
        ...
        jComboBoxName.setFont(new java.awt.Font("Calibri", 0, 24)); // NOI18N
    ...
    private void jComboTimeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboTimeActionPerformed
        ...
        if (!feedingTime.equals("Zeit auswählen") || !animalName.equals("Tier auswählen")) {
            jButtonSearch.setEnabled(true);
        } else {
            jButtonSearch.setEnabled(false);
        }
    ...
    private void jButtonSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSearchActionPerformed
        ...
        //choosed animalName
        if (!animalName.equals("Tier auswählen") && feedingTime.equals("Zeit auswählen")) {
