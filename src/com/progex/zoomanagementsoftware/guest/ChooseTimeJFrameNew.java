 ...
 *
 */
public class ChooseTimeJFrameNew extends javax.swing.JFrame {

    /**
     * Creates new form ZeitjFrame
     */
    public ChooseTimeJFrameNew(JFrame goBackFrame, ZooManager zooManager, String time) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChooseTimeJFrameNew.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChooseTimeJFrameNew(null, zooManager, null).setVisible(true);
            }
        });
    }
