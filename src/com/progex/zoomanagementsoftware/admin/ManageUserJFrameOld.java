...
public class ManageUserJFrameOld extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTableUserData.setAutoscrolls(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManageUserJFrameOld.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManageUserJFrameOld(null).setVisible(true);
            }
        });
    }
